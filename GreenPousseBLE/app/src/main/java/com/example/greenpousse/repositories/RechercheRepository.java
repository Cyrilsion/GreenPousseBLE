...
public class RechercheRepository {
    ...
    public void sendMail(String objet, String adresse, String message) {
        isUpdating.setValue(true);
        RequestPackage requestPackage = requestData(MAIL_URL, "objet", objet );
            ...
            if (result != null) {
                    ...
                    for (int i = 0; i < resultJsonArray.length(); i++) {
                        try {
                            ...
                            Dechet newDechet = new Dechet(jsonObject.getInt("ID"), jsonObject.getString("DECHET"), jsonObject.getInt("COMPOSTABLE"));
