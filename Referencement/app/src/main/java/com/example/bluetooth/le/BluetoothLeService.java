...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                Log.i(TAG, "onConnectionStateChange: requesting higher mtu" + gatt.requestMtu(256));
    ...
    public boolean connect(final String address) {
        ...
        //Most of the time, the autoconnect parameter should be set to false. Setting it to true
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        //If you want to enable notifications for your peripheral,
        //regardless of what kind is it, you have to do this.
        if (SampleGattAttributes.CHARACTERISTIC_UUID.equals(characteristic.getUuid())) {
