...
import com.example.referencement.login.LoginDataSource;
...
public class LoginRepository {
    ...
    private void setLoggedInUser(InscriptionActivity.LoggedInUser user) {
        this.user = user;
        // If user credentials will be cached in local storage, it is recommended it be encrypted
        // @see https://developer.android.com/training/articles/keystore
    }

    public Result<InscriptionActivity.LoggedInUser> login(String username, String password) {
        // handle login
